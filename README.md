A web-based application for calculating scores in the game Ao Oni, based on the game's original scoring algorithm. Supports both Normal and Roguelike game modes with detailed score breakdowns.
